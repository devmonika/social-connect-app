...
const Login = () => {
    return (
        <div>
            {/* <img src="" className='relative w-full max-h-screen' alt=""/> */}
            ...
            <div class="flex items-center min-h-screen p-4 lg:justify-center">
                ...
                >
                    ...
                    <div class="my-3 text-3xl font-bold tracking-wider text-center">
                        <a href="#">Everything You Need to Know, Just Ask!!</a>
                    </div>
                    ...
                    <form action="#" class="flex flex-col space-y-5">
                        ...
                        <button
                            type="submit"
                            class="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-primary rounded-md shadow hover:bg-secondary focus:outline-none focus:ring-blue-200 focus:ring-4"
                        >
                            Log in
                        </button>
                        </div>
                        ...
                        <div class="flex flex-col space-y-4">
                            <a
                            href="#"
                            class="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-gray-800 rounded-md group hover:bg-secondary focus:outline-none"
                            >
                            <span>
                                <FcGoogle></FcGoogle>
                            </span>
